  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'stats', name: 'Stats', component: () => import('@/pages/StatsOverviewPage.vue'), meta: { title: '分析总览', icon: 'stats' } },
        { path: 'stats/content', name: 'StatsContent', component: () => import('@/pages/StatsContentPage.vue'), meta: { title: '内容分析' } },
        { path: 'stats/users', name: 'StatsUsers', component: () => import('@/pages/StatsUsersPage.vue'), meta: { title: '用户分析' } },
